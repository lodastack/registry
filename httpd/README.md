...
```
curl -X POST -d '{"addr":"127.0.0.2:9981"}' "http://127.0.0.1:9991/api/v1/peer"
```
#### 0.2 删除成员

根据raft端口地址，从集群中删除一个成员。

```
curl -X DELETE -d '{"addr":"127.0.0.2:9981"}' "http://127.0.0.1:9991/api/v1/peer"
```
