...
func (ms *mockStore) Update(bucket []byte, key []byte, value []byte) error { return nil }

func (ms *mockStore) CreateBucket(name []byte) error { return nil }

func (ms *mockStore) RemoveBucket(name []byte) error { return nil }
